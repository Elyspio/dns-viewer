...
using DnsViewer.Api.Abstractions.Helpers;
using DnsViewer.Api.Abstractions.Interfaces.Injections;
using DnsViewer.Api.Adapters.Injections;
using DnsViewer.Api.Core.Injections;
...
namespace DnsViewer.Api.Web.Server;
...
public class ServerBuilder
{
    ...
    public ServerBuilder(string[] args)
    {
        ...
        builder.Services.AddModule<DnsViewApiAdapterModule>(builder.Configuration);
        builder.Services.AddModule<DnsViewApiCoreModule>(builder.Configuration);
